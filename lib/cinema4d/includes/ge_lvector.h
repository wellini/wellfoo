...
struct Vector64
{
	...
	/// @param[in] ix									Assigned to Vector64::x.
	/// @param[in] iy									Assigned to Vector64::y.
	/// @param[in] iz									Assigned to Vector64::z.
	//----------------------------------------------------------------------------------------
	...
	/// @param[in] in									Assigned to Vector64::x, Vector64::y and Vector64::z.
	//----------------------------------------------------------------------------------------
	...
	///																@em 0 returns Vector64::x, @em 1 returns Vector64::y and @em 2 returns Vector64::z.\n
	...
	//----------------------------------------------------------------------------------------
	/// Checks component-wise if the difference between the vector and @formatParam{v2} is no bigger than @formatParam{epsilon}.
	...
	//----------------------------------------------------------------------------------------
	/// Calculates the average value of Vector64::x, Vector64::y and Vector64::z components.
	...
	//----------------------------------------------------------------------------------------
	/// Calculates the sum of Vector64::x, Vector64::y and Vector64::z components.
	...
	//----------------------------------------------------------------------------------------
	/// Gets the minimum of Vector64::x, Vector64::y and Vector64::z components.
	...
	//----------------------------------------------------------------------------------------
	/// Gets the maximum of Vector64::x, Vector64::y and Vector64::z components.
	...
	//----------------------------------------------------------------------------------------
	/// Gets the vector clamped to the range @em [0.0 .. 1.0].
	/// @return												The vector clamped to the range @em [0.0 .. 1.0].
	//----------------------------------------------------------------------------------------
	Vector64 Clamp01() const
	{
		return Vector64(melange::Clamp01(x), melange::Clamp01(y), melange::Clamp01(z));
	}

	//----------------------------------------------------------------------------------------
	/// Calculates angle (in radians) between @formatParam{v1} and @formatParam{v2}.
	...
	//----------------------------------------------------------------------------------------
	/// Calculates dot product of vectors @formatParam{v1} and @formatParam{v2}.
	/// @param[in] v1									The first vector.
	/// @param[in] v2									The second vector.
	...
	//----------------------------------------------------------------------------------------
	/// Subtracts vector @formatParam{v} from this vector.
