...
struct Vector32
{
	...
	/// @param[in] ix									Assigned to Vector32::x.
	/// @param[in] iy									Assigned to Vector32::y.
	/// @param[in] iz									Assigned to Vector32::z.
	//----------------------------------------------------------------------------------------
	...
	/// @param[in] in									Assigned to Vector32::x, Vector32::y and Vector32::z.
	//----------------------------------------------------------------------------------------
	...
	///																@em 0 returns Vector32::x, @em 1 returns Vector32::y and @em 2 returns Vector32::z.\n
	...
	//----------------------------------------------------------------------------------------
	/// Calculates the average value of Vector32::x, Vector32::y and Vector32::z components.
	...
	//----------------------------------------------------------------------------------------
	/// Calculates the sum of Vector32::x, Vector32::y and Vector32::z components.
	...
	//----------------------------------------------------------------------------------------
	/// Gets the minimum of Vector32::x, Vector32::y and Vector32::z components.
	...
	//----------------------------------------------------------------------------------------
	/// Gets the maximum of Vector32::x, Vector32::y and Vector32::z components.
	...
	{
		return Vector32(melange::Clamp01(x), melange::Clamp01(y), melange::Clamp01(z));
	}
	...
	//----------------------------------------------------------------------------------------
	/// Adds this vector and vector @formatParam{v}.
