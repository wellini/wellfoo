...
struct Matrix32
{
	...
	//----------------------------------------------------------------------------------------
	/// Matrix product. Multiply the matrix and matrix @formatParam{m2}.\n
	...
	//----------------------------------------------------------------------------------------
	/// Scales each element of matrix @formatParam{m} by scalar @formatParam{s}.
	...
	//----------------------------------------------------------------------------------------
	/// Scales each element of the matrix by scalar @formatParam{s}.
	/// @param[in] s									The scalar.
	/// @return												The result of the scalar multiplication.
	//----------------------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------------------
	/// Divides each element in matrix @formatParam{m} by scalar @formatParam{s}.
	...
	//----------------------------------------------------------------------------------------
	/// Equality operator. Checks if all elements in matrix @formatParam{m1} are identical to all elements in matrix @formatParam{m2}.
	/// @param[in] m1									The first matrix.
	/// @param[in] m2									The second matrix.
	...
	//----------------------------------------------------------------------------------------
	/// Equality operator. Checks if any element in matrix @formatParam{m1} is different to any element in matrix @formatParam{m2}.
	/// @param[in] m1									The first matrix.
	/// @param[in] m2									The second matrix.
	...
	//----------------------------------------------------------------------------------------
	Vector32 Scale(void) const
	{
		return Vector32(Len(v1), Len(v2), Len(v3));
	}
