...
struct Matrix64
{
	...
	//----------------------------------------------------------------------------------------
	/// Default constructor. Construct a unit matrix.
	//----------------------------------------------------------------------------------------
	Matrix64()
	{
	...
	///																@em 0 returns Matrix64::off, @em 1 returns Matrix64::v1, @em 2 returns Matrix64::v2, @em 3 returns Matrix64::v3.\n
	///																Any other value must not be used and will crash.
	/// @return												The vector at index @formatParam{i}.
	//----------------------------------------------------------------------------------------
	Vector64& operator [] (Int32 i) const
	{
		return ((Vector64*)this)[i & 3];
	}
	...
	//----------------------------------------------------------------------------------------
	Vector64 Scale(void) const
	{
		return Vector64(Len(v1), Len(v2), Len(v3));
	}
