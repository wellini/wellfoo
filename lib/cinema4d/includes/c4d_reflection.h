...
#define REFLECTION_FLAG_SEPARATE											0x10			///< Separate.
...
#define REFLECTION_LAYER_SAMPLING_SAMPLE_COUNT_EX			0x00B8			///< @markDeprecated
...
public:
	...
	Int32 layerID;			///< The layer ID.
	Int32 flags;				///< The flags for the layer: @enumerateEnum{REFLECTION_FLAG}

	// Base data ID is based on the layer id
	//----------------------------------------------------------------------------------------
