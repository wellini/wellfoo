...
{
public:
	static void	MoveFrom(const char* src, char* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(char)));
	}
	static char* CopyFrom(const char* src, char* dst, Int copyCnt)
	{
		return (char*) memcpy(dst, src, size_t(copyCnt * SIZEOF(char)));
	}
	static char* TryRealloc(ALLOCATOR& a, char* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (char*) a.Realloc(ptr, s);
	}
};
...
{
public:
	static void MoveFrom(const short* src, short* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(short)));
	}
	static short* CopyFrom(const short* src, short* dst, Int copyCnt)
	{
		return (short*) memcpy(dst, src, size_t(copyCnt * SIZEOF(short)));
	}
	static short* TryRealloc(ALLOCATOR& a, short* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (short*) a.Realloc(ptr, s);
	}
};
...
{
public:
	static void MoveFrom(const int* src, int* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(int)));
	}
	static int*	CopyFrom(const int* src, int* dst, Int copyCnt)
	{
		return (int*) memcpy(dst, src, size_t(copyCnt * SIZEOF(int)));
	}
	static int*	TryRealloc(ALLOCATOR& a, int* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (int*) a.Realloc(ptr, s);
	}
};
...
{
public:
	static void MoveFrom(const long* src, long* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(long)));
	}
	static long* CopyFrom(const long* src, long* dst, Int copyCnt)
	{
		return (long*) memcpy(dst, src, size_t(copyCnt * SIZEOF(long)));
	}
	static long* TryRealloc(ALLOCATOR& a, long* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (long*) a.Realloc(ptr, s);
	}
};
...
{
public:
	static void MoveFrom(const long long* src, long long* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(long long)));
	}
	static long long* CopyFrom(const long long* src, long long* dst, Int copyCnt)
	{
		return (long long*) memcpy(dst, src, size_t(copyCnt * SIZEOF(long long)));
	}
	static long long* TryRealloc(ALLOCATOR& a, long long* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (long long*) a.Realloc(ptr, s);
	}
};
...
{
public:
	static void MoveFrom(const unsigned char* src, unsigned char* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(unsigned char)));
	}
	static unsigned char*				CopyFrom(const unsigned char* src, unsigned char* dst, Int copyCnt)
	{
		return (unsigned char*) memcpy(dst, src, size_t(copyCnt * SIZEOF(unsigned char)));
	}
	static unsigned char*				TryRealloc(ALLOCATOR& a, unsigned char* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (unsigned char*) a.Realloc(ptr, s);
	}
};
...
{
public:
	static void MoveFrom(const unsigned short* src, unsigned short* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(unsigned short)));
	}
	static unsigned short*			CopyFrom(const unsigned short* src, unsigned short* dst, Int copyCnt)
	{
		return (unsigned short*) memcpy(dst, src, size_t(copyCnt * SIZEOF(unsigned short)));
	}
	static unsigned short*			TryRealloc(ALLOCATOR& a, unsigned short* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (unsigned short*) a.Realloc(ptr, s);
	}
};
...
{
public:
	static void MoveFrom(const unsigned int* src, unsigned int* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(unsigned int)));
	}
	static unsigned int*				CopyFrom(const unsigned int* src, unsigned int* dst, Int copyCnt)
	{
		return (unsigned int*) memcpy(dst, src, size_t(copyCnt * SIZEOF(unsigned int)));
	}
	static unsigned int*				TryRealloc(ALLOCATOR& a, unsigned int* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (unsigned int*) a.Realloc(ptr, s);
	}
};
...
{
public:
	static void MoveFrom(const unsigned long* src, unsigned long* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(unsigned long)));
	}
	static unsigned long* CopyFrom(const unsigned long* src, unsigned long* dst, Int copyCnt)
	{
		return (unsigned long*) memcpy(dst, src, size_t(copyCnt * SIZEOF(unsigned long)));
	}
	static unsigned long* TryRealloc(ALLOCATOR& a, unsigned long* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (unsigned long*) a.Realloc(ptr, s);
	}
};
...
{
public:
	static void MoveFrom(const unsigned long long* src, unsigned long long* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(unsigned long long)));
	}
	static unsigned long long*	CopyFrom(const unsigned long long* src, unsigned long long* dst, Int copyCnt)
	{
		return (unsigned long long*) memcpy(dst, src, size_t(copyCnt * SIZEOF(unsigned long long)));
	}
	static unsigned long long*	TryRealloc(ALLOCATOR& a, unsigned long long* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (unsigned long long*) a.Realloc(ptr, s);
	}
};
...
{
public:
	static void MoveFrom(const float* src, float* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(float)));
	}
	static float* CopyFrom(const float* src, float* dst, Int copyCnt)
	{
		return (float*) memcpy(dst, src, size_t(copyCnt * SIZEOF(float)));
	}
	static float* TryRealloc(ALLOCATOR& a, float* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (float*) a.Realloc(ptr, s);
	}
};
...
public:
	...
	static void MoveFrom(const double* src, double* dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(double)));
	}
	static double* CopyFrom(const double* src, double* dst, Int copyCnt)
	{
		return (double*) memcpy(dst, src, size_t(copyCnt * SIZEOF(double)));
	}
	static double* TryRealloc(ALLOCATOR& a, double* ptr, Int s, Bool& isRealloc)
	{
		isRealloc = true;
		return (double*) a.Realloc(ptr, s);
	}
};
...
{
public:
	static void MoveFrom(T* const* src, T** dst, Int moveCnt)
	{
		memmove(dst, src, size_t(moveCnt * SIZEOF(T*)));
	}
	static T**	CopyFrom(T* const* src, T** dst, Int copyCnt)
	{
		return (T**) memcpy(dst, src, size_t(copyCnt * SIZEOF(T*)));
	}
	static T**	TryRealloc(ALLOCATOR& a, T** ptr, Int s, Bool& isRealloc)
...
public:
	...
	//----------------------------------------------------------------------------------------
	/// Checks if the array is empty. This is the same as <tt>GetCount() == 0</tt>
	...
	template <typename SourceArray> Bool CopyFrom(const SourceArray& src, Bool fitToSize = true)
	{
		...
		T* element = (T*) this->Alloc(_capacity * SIZEOF(T));
		if (element)
		{
...
protected:
	Bool FitToSize(Int newCapacity)
	{
		if (newCapacity >= _cnt)
		{
			...
			T* newArray = (T*) this->Alloc(newCapacity * SIZEOF(T));	// using Realloc() wouldn't work because it won't shrink an existing block (furthermore if it would we'd have problems with the constructors)
			if (newArray)
			{
